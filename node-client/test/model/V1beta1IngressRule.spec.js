...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoyagerJsClient.V1beta1IngressRule();
  });
  ...
  describe('V1beta1IngressRule', function() {
    it('should create an instance of V1beta1IngressRule', function() {
      ...
      //var instane = new VoyagerJsClient.V1beta1IngressRule();
      //expect(instance).to.be.a(VoyagerJsClient.V1beta1IngressRule);
    });
