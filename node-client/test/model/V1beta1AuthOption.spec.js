...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoyagerJsClient.V1beta1AuthOption();
  });
  ...
  describe('V1beta1AuthOption', function() {
    it('should create an instance of V1beta1AuthOption', function() {
      // uncomment below and update the code to test V1beta1AuthOption
      //var instane = new VoyagerJsClient.V1beta1AuthOption();
      //expect(instance).to.be.a(VoyagerJsClient.V1beta1AuthOption);
    });
