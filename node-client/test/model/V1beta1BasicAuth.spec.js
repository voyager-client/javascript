...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoyagerJsClient.V1beta1BasicAuth();
  });
  ...
  describe('V1beta1BasicAuth', function() {
    it('should create an instance of V1beta1BasicAuth', function() {
      // uncomment below and update the code to test V1beta1BasicAuth
      //var instane = new VoyagerJsClient.V1beta1BasicAuth();
      //expect(instance).to.be.a(VoyagerJsClient.V1beta1BasicAuth);
    });
