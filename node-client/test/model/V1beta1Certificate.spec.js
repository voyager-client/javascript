...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoyagerJsClient.V1beta1Certificate();
  });
  ...
  describe('V1beta1Certificate', function() {
    it('should create an instance of V1beta1Certificate', function() {
      // uncomment below and update the code to test V1beta1Certificate
      //var instane = new VoyagerJsClient.V1beta1Certificate();
      //expect(instance).to.be.a(VoyagerJsClient.V1beta1Certificate);
    });
