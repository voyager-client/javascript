...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoyagerJsClient.V1beta1IngressTLS();
  });
  ...
  describe('V1beta1IngressTLS', function() {
    it('should create an instance of V1beta1IngressTLS', function() {
      ...
      //var instane = new VoyagerJsClient.V1beta1IngressTLS();
      //expect(instance).to.be.a(VoyagerJsClient.V1beta1IngressTLS);
    });
